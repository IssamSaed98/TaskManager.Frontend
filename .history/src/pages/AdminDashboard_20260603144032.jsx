...
function AdminDashboard({ onLogout }) {
  ...
  const StatsGrid = () => (
    <div className="grid grid-cols-2 gap-3 mb-4">
      {[
        { label: t('total_tasks'),     value: totalTasks,     color: '#60a5fa', bg: 'rgba(21,101,192,0.08)',  border: 'rgba(21,101,192,0.2)',  icon:  (<img src={taskList} alt="Tasks" style={{ width: 24, height: 24 }}/>
      ) },
