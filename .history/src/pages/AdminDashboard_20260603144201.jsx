  ...
  const StatsGrid = () => (
    <div className="grid grid-cols-2 gap-3 mb-4">
      {[
        ...
        { label: t('completed_tasks'), value: completedTasks, color: '#4ade80', bg: 'rgba(34,197,94,0.08)',   border: 'rgba(34,197,94,0.2)',   icon:  (<img src={taskList} alt="Tasks" style={{ width: 25, height: 25 }}/>) },
