...
function AdminDashboard({ onLogout }) {
  ...
  const StatsGrid = () => (
    <div className="grid grid-cols-2 gap-3 mb-4">
      {[
        { label: t('total_tasks'),     value: totalTasks,     color: '#60a5fa', bg: 'rgba(21,101,192,0.08)',  border: 'rgba(21,101,192,0.2)',  icon:  (<img src={taskList} alt="Tasks" style={{ width: 25, height: 25 }}/>) },
        { label: t('active_tasks'),    value: activeTasks,    color: '#fbbf24', bg: 'rgba(251,191,36,0.08)',  border: 'rgba(251,191,36,0.2)',  icon: '⚡' },
        { label: t('completed_tasks'), value: completedTasks, color: '#4ade80', bg: 'rgba(34,197,94,0.08)',   border: 'rgba(34,197,94,0.2)',   icon:  (<img src={compTask} alt="Tasks" style={{ width: 25, height: 25 }}/>) },
        { label: t('employees'),       value: users.length,   color: '#a78bfa', bg: 'rgba(124,58,237,0.08)',  border: 'rgba(124,58,237,0.2)',  icon:  (<img src={mitar} alt="Tasks" style={{ width: 25, height: 25 }}/>)  },
      ].map((s, i) => (
