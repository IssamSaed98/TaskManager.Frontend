...
function AdminDashboard({ onLogout }) {
  ...
  const navItems = [
    ...
    { key: 'employees', icon: (<img src={mitarbeitern}  style={{ width: 20, height: 20}}/>), label: t('employees') },
    { key: 'tasks',     icon: (<img src={taskList}  style={{ width: 20, height: 20}}/>), label: t('all_tasks') },
    { key: 'reports',   icon:  (<img src={  reports}  style={{ width: 20, height: 20}}/>), label: t('reports') },
  ]
