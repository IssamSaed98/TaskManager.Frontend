        ...
        >
          ...
          <div className="mb-4">
            <motion.div
              ...
              style={{
                ...
                border: `1px solid ${focusedField === 'email' ? 'rgba(34,184,255,0.5)' : 'rgba(34,184,255,0.1)'}`,
                boxShadow: focusedField === 'email' ? '0 0 20px rgba(34,184,255,0.15)' : 'none',
              }}
            >
          ...
          <div className="mb-4">
            <motion.div
              ...
              style={{
                background: 'rgba(2,11,26,0.6)',
                border: `1px solid ${focusedField === 'password' ? 'rgba(34,184,255,0.5)' : 'rgba(34,184,255,0.1)'}`,
                boxShadow: focusedField === 'password' ? '0 0 20px rgba(34,184,255,0.15)' : 'none',
              }}
            >
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-xs" style={{ color: '#22B8FF' }}>{t('forgot_password')}</button>
          </div>
          ...
          <motion.button
            onClick={handleLogin}
            disabled={loading}
            className="w-full py-4 rounded-2xl text-white font-bold text-sm mb-6"
            style={{
          ...
          <div className="flex items-center gap-3 mb-5">
            <div className="flex-1 h-px" style={{ background: 'rgba(34,184,255,0.1)' }} />
            <span className="text-xs" style={{ color: '#3a5070' }}>أو تابع باستخدام</span>
            <div className="flex-1 h-px" style={{ background: 'rgba(34,184,255,0.1)' }} />
          </div>
          ...
          <div className="flex gap-3 mb-6">
            {['🪟', '🍎', 'G'].map((icon, i) => (
              <motion.button
                ...
                whileHover={{ scale: 1.05, boxShadow: '0 0 15px rgba(34,184,255,0.15)' }}
                whileTap={{ scale: 0.95 }}
              >
                {icon}
              </motion.button>
