          ...
          <div className="p-9">
            ...
            <div className="mb-5">
              <h2 className="text-xl font-bold mb-1" style={{ color: '#e2f0ff' }}>
                {isAdmin ? 'إنشاء حساب مدير 👑' : 'إنشاء حساب موظف 👤'}
              </h2>
              <p className="text-xs" style={{ color: 'rgba(14,165,233,0.35)' }}>
                {isAdmin ? 'ستنشئ منظمة جديدة وتكون مديرها' : 'أدخل رقم المنظمة التي تنتمي إليها'}
              </p>
            </div>
            ...
            {/* حقل خاص بالمدير أو الموظف */}
            <div className="mb-4">
              <label className="block text-xs font-semibold mb-2" style={{ color: 'rgba(14,165,233,0.35)', letterSpacing: '0.8px' }}>
                {isAdmin ? 'اسم المنظمة' : 'رقم المنظمة'}
              </label>
              <input
                ...
                placeholder={isAdmin ? 'مثال: مطعم الأصالة' : 'مثال: 1'}
                className="w-full rounded-xl px-4 py-3 text-sm outline-none"
                style={{ background: 'rgba(4,15,35,0.6)', border: '1px solid rgba(14,165,233,0.08)', color: '#7dd3fc', fontFamily: 'inherit' }} />
              {!isAdmin && (
                <p className="text-xs mt-1" style={{ color: 'rgba(14,165,233,0.25)' }}>
                  اطلب رقم المنظمة من مديرك
                </p>
              )}
            </div>
